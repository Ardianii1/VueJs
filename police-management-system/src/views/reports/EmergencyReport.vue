...
export default {
    ...
    methods: {
        async handleCreateEmergency() {
            ...
            this.errors = {};
            console.log(this.emergency.CreatedAt)
            let apiURL = "http://localhost:3000/emergencys/create";
            const { error, value } = this.emergencySchema.validate(this.emergency, { abortEarly: false });
            if (error) {
            ...
            formData.append('Type', this.emergency.Type);
            formData.append('Dateof', this.emergency.Dateof);
            formData.append('Locationn', this.emergency.Locationn);
            formData.append('Description', this.emergency.Description);
            formData.append('Injuries', this.emergency.Injuries);
            formData.append('ContactOfperson', this.emergency.ContactOfperson);
            formData.append('photo', this.$refs.fileInput.files[0]);
            formData.append('photoName', this.emergency.photoName);
            formData.append('Status', this.emergency.Status);

            const response = await axios.post(apiURL, formData, {})
            console.log(this.currentUserEmail)
            // this.$router.push("/admin/emergency");
        },
        validateFile(event) {
            ...
            this.emergency.photoName = `${generateFileName()}.${file.type.split('/')[1]}`;
        },
        clearErrors() {
            this.errors = {};
        },
...
<template >
    <div>
        <div class="flex justify-center pt-10 ">
            <form @submit.prevent="handleCreateEmergency" enctype="multipart/form-data"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <select v-model="emergency.Type" name="type" id="type"
                            ...
                            <option value="">Select the type of the emergency</option>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="emergency.Dateof" name="dateof" id="dateof" ref="dateInput"
                        ...
                        <label for="Dateof"
                            ...
                            of the emergency</label>
                        <div v-if="this.errors.Dateof" class="text-red-500">{{ this.errors.Dateof }}</div>
                    </div>
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" v-model="emergency.Locationn" name="Locationn" id="Locationn"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " />
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="emergency.Description" name="Description" id="Description"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="emergency.Injuries" name="Injuries" id="Injuries"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                        <label for="Injuries"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="emergency.ContactOfperson" name="ContactOfperson" id="ContactOfperson"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                        ...
                        <div v-if="this.errors.ContactOfperson" class="text-red-500">{{this.errors.ContactOfperson }}</div>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
