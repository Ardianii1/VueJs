<template>
    <div>
        ...
        <!-- <div class="flex py-3 justify-center items-center  bg-slate-300">
            <form @submit.prevent="handleTransferCase"
                ...
                <div class="grid gap-3 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input v-model="newCase.identifier" type="text" id="identifier"
                    ...
                    <div>
                        ...
                        <input v-model="newCase.description" type="text" id="text"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input v-model="newCase.caseNumber" type="text" id="location"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input v-model="newCase.notes" type="text" id="phone"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input v-model="newCase.storageLocation" type="text" id="website"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input v-model="newCase.handlingInstructions" name="status" id="status"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div>
                        <label for="createdBy" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Assigned
                            Officier</label>
                        <input v-model="newCase.newOfficer" name="createdBy" id="createdBy"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                <button type="sumbit"
                ...
                <router-link :to="`/admin/case-management`"><button type="reset"
        ...
        <div class="flex justify-center pt-0 ">
            <form @submit.prevent="handleTransferCase" enctype="multipart/form-data"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newCase.casenumber" name="caseNumber" id="caseNumber"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newCase.dateof" name="date" id="date" ref="dateInput"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                        <label for="dateof"
                            ...
                            and time of the incident</label>
                        <div v-if="this.errors.dateof" class="text-red-500">{{ this.errors.dateof }}</div>
                    </div>
                </div>
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newCase.location" name="location" id="floating_location"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newCase.description" name="description" id="floating_description"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newCase.parties" name="parties" id="parties"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                        <label for="parties"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <select v-model="newCase.status" name="status" id="status"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newCase.notes" name="notes" id="notes"
                            ...
                            placeholder=" " />
                        <label for="notes"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Any
                            relevant notes or observations</label>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newCase.transfernotes" name="transfernotes" id="transfernotes"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                        <label for="transfernotes"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Transfer
                            Notes</label>
                        <div v-if="this.errors.transfernotes" class="text-red-500">{{ this.errors.transfernotes }}</div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        async handleTransferCase() {
            console.log(this.newCase)
            try {
                // this.newCase.createdBy = this.newCase.newOfficer
                console.log(this.newCase)
                const response = await axios.put(`http://localhost:3000/cases/transfer/${this.$route.params.id}`, this.newCase, {
                    headers: {
    ...
    created() {
        ...
        axios.get(apiURL).then((res) => {
            ...
            this.newCase.newOfficer = this.newCase.createdBy
        });
