      ...
      <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <thead class="w-full text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr class="">
                <th scope="col" class="px-4 py-3">
                  <a href="#" @click="sortByy('casenumber')" class="flex"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <th scope="col" class="px-4 py-3">
                  <a href="#" @click="sortByy('location')" class="flex"><svg xmlns="http://www.w3.org/2000/svg"
                      class="w-4 h-4 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 320 512">
                      <path
                        d="M27.66 224h264.7c24.6 0 36.89-29.78 19.54-47.12l-132.3-136.8c-5.406-5.406-12.47-8.107-19.53-8.107c-7.055 0-14.09 2.701-19.45 8.107L8.119 176.9C-9.229 194.2 3.055 224 27.66 224zM292.3 288H27.66c-24.6 0-36.89 29.77-19.54 47.12l132.5 136.8C145.9 477.3 152.1 480 160 480c7.053 0 14.12-2.703 19.53-8.109l132.3-136.8C329.2 317.8 316.9 288 292.3 288z" />
                    </svg>Location</a>
                ...
                <th scope="col" class="px-4 py-3">
                  <a href="#" @click="sortByy('date')" class="flex"><svg xmlns="http://www.w3.org/2000/svg"
                      class="w-4 h-4 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 320 512">
                      <path
                        d="M27.66 224h264.7c24.6 0 36.89-29.78 19.54-47.12l-132.3-136.8c-5.406-5.406-12.47-8.107-19.53-8.107c-7.055 0-14.09 2.701-19.45 8.107L8.119 176.9C-9.229 194.2 3.055 224 27.66 224zM292.3 288H27.66c-24.6 0-36.89 29.77-19.54 47.12l132.5 136.8C145.9 477.3 152.1 480 160 480c7.053 0 14.12-2.703 19.53-8.109l132.3-136.8C329.2 317.8 316.9 288 292.3 288z" />
                    </svg>Date</a>
            ...
            <tbody>
              <tr v-for="cases in itemsToDisplay" :key="cases.id" class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3 truncate text-right ">
                  <router-link :to="`/admin/case-management/transfer/${cases._id}`"
                  ...
                  <router-link :to="`/admin/case-management/details/${cases._id}`"
                    class="inline-flex items-center mr-3 px-3 py-2 text-sm font-medium text-center text-white bg-slate-600 hover:bg-slate-700 rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" class="w-4 h-4 mr-2">
                      <path stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <router-link :to="`/admin/case-management/edit/${cases._id}`"
                    ...
                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000svg">
                      <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2828z"></path>
                      <path fill-rule="evenodd"
                        d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"
                        clip-rule="evenodd"></path>
                    </svg>Edit</router-link>
                  <button type="button" @click="handleDeleteCase(cases._id)" data-modal-toggle="delete-user-modal"
        ...
        <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
          ...
          <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
            Showing
            <span class="font-semibold text-gray-900 dark:text-white">1-{{ caseees.length > 7 ? 7 : caseees.length
            }}</span>
            of
          ...
          <ul class="inline-flex items-stretch -space-x-px">
            <li>
              <button type="button"
                ...
                :disabled="currentPage === 1" @click="prevPage"><span class="sr-only">Previous</span><svg class="w-5 h-5"
            ...
            <span v-for="pageNumber in pagesToShow" :key="pageNumber">
              <button
                ...
                @click="currentPage = pageNumber" :class="{ active: currentPage === pageNumber }">{{ pageNumber
                }}</button>
            </span>
            <li>
              <button type="button"
                ...
                :disabled="currentPage === totalPages" @click="nextPage"><span class="sr-only">Next</span><svg
