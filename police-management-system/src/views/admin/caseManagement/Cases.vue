  ...
  <div class="flex justify-center">
    <div class="relative mt-5 w-[90%]  overflow-x-auto shadow-md sm:rounded-lg">
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr v-for="casee in sortedCases" :key="casee.id"
            ...
            <td class="px-6 py-4 text-right ">
              <router-link :to="`/admin/case-management/details/${casee._id}`"
              ...
              <router-link :to="`/admin/case-management/edit/${casee._id}`"
              ...
              <button type="button" @click="handleDeleteCase(casee._id)" data-modal-toggle="delete-user-modal"
...
export default {
  ...
  methods: {
    handleDeleteCase(id) {
      let apiURL = `http://localhost:3000/cases/${id}`;
      let indexOfArrayItem = this.cases.findIndex((i) => i._id === id);
      if (window.confirm("Do you really want to delete?")) {
        axios
          .delete(apiURL)
          .then(() => {
            this.cases.splice(indexOfArrayItem, 1);
          })
          .catch((error) => {
            console.log(error);
          });
